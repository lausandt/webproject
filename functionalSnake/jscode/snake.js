...
var snake = (function() {
    ...
    function doMove(direction) {
        ...
        if (collidesWithOneOf(newHead, model.state.snake)) {
            ...
            $("#winlose").html("You've lost the game");
            stats();
        }
        else {
    ...
    */
    ...
    function playConfetti() {
        // Hernoem canvas voor de confetti
        $("#mySnakeCanvas").attr("id","confetti-canvas");
        confetti.start(3000);
        // Zet canvas weer terug naar oude versie
        $("#confetti-canvas").attr("id","mySnakeCanvas");
    }
    ...
    return { 
        ...
        // Alleen voor tests: Deze moeten exposed worden 
        // omdat we anders de functionaliteit van snake.js niet kunnen
        // testen.
        canMove: canMove,
        move: move,
        head: head,
        collidesWithOneOf: collidesWithOneOf,
        eat: eat,
